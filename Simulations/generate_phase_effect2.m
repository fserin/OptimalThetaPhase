...
function [phasetrials,total_effect_analysed] = generate_phase_effect2(effectpresent,peak_pos,peak_neg,w_pos,w_neg,w_total,a_norm,offset,no_trials_bin,nbins_analysis,nbins_total,mode)
